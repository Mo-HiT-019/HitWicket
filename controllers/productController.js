...
const renderAddProduct = async (req, res) => {
  try {
    ...
    res.render('admin/add-product', { categories,msg:req.flash('errorMessage') });
  } catch (error) {
...
const addProduct = async (req, res) => {
  ...
  const viewProducts = async (req, res) => {
    try {
      ...
      res.render('admin/view-products', { products, page, PAGE_SIZE, totalCount,totalPages,msg:req.flash('errorMessage') });
